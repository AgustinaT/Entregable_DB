...
--
-- Host: localhost    Database: Entregable_MAT
-- ------------------------------------------------------
...
CREATE TABLE `notes_categories` (
  ...
  KEY `notes_categories_FK` (`notes_id`),
  KEY `notes_categories_FK_1` (`categories_id`),
  CONSTRAINT `notes_categories_FK` FOREIGN KEY (`notes_id`) REFERENCES `notes` (`id`),
  CONSTRAINT `notes_categories_FK_1` FOREIGN KEY (`categories_id`) REFERENCES `categories` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'Entregable_MAT'
--
...
-- Dump completed on 2021-11-28 14:54:28
